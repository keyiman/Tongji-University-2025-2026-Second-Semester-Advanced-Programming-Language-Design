...
struct tj_time *tj_time_convert(int input_time)
{
	...
	total_second = (long long)input_time + 8LL * 60 * 60; // 加 8h

	result.tj_second = (int)(total_second % 60);
	total_second /= 60;
	result.tj_minute = (int)(total_second % 60);
	total_second /= 60;
	result.tj_hour = (int)(total_second % 24);
	day_cnt = total_second / 24;
